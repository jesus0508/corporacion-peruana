          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group @error('ruc') has-error @enderror">
                ...
                <input id="ruc" type="text" class="form-control number-validation" value="{{old('ruc')}}" 
                        name="ruc" placeholder="Ingrese su RUC" title="Numero de 11 digitos"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group @error('dni') has-error @enderror">
                ...
                <input id="dni" type="text" class="form-control number-validation" value="{{old("dni")}}" 
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group @error('telefono') has-error @enderror">
                ...
                <input id="telefono" type="tel" class="form-control number-validation" value="{{old("telefono")}}" 
                        name="telefono" placeholder="Número de telefono" 
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group @error('linea_credito') has-error @enderror">
                ...
                <input id="linea_credito" type="number" class="form-control number-validation" value="{{old("linea_credito")}}" 
                        name="linea_credito" placeholder="Ingrese la linea de credito" 
          ...
          <div class="row">            
            ...
            <div class="form-group @error('correo_representante') has-error @enderror">
                ...
                <input id="correo_representante" type="email" class="form-control" value="{{old("correo_representante")}}" 
