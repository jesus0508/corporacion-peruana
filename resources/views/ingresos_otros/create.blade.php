<div class="row">
  <!-- left column -->
  <form class="" action="{{route('ingresos_otros.store')}}" method="post">
    @csrf
    <div class="col-md-8">
      <!-- general form elements -->
      <div class="box box-success">
        <div class="box-header with-border">
          <h2 class="box-title">Datos Principales </h3>
        </div><!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" name="categoria_ingreso_id" id="categoria_ingreso">
            ...
            <div class="col-md-4">
              <div class="form-group @error('monto') has-error @enderror">
                ...
                <input id="monto" type="text" class="form-control" value="{{old('monto')}}"
                        name="monto" placeholder="Ingrese el monto " required>
                @error('monto')
    ...
    <div class="col-md-4">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h2 class="box-title">Datos complementarios(opcionales)</h2>
        </div><!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
