  <div class="row">
    <div class="col-md-12">
      ...
      <div class="pull-right">
        @if( isset($pedido) )
          <button class="btn btn-default" id="export_factura_table">  <span class="fa  fa-file-excel-o"></span>
            Exportar Excel            
          </button>
        @endif
        @if( isset($pedido) )
          @if( $pedido->estado >= 4 )
            <a class="btn bg-maroon" href="{{route('pago_proveedors.edit', $pedido->id)}}">
