    ...
    <div class="modal-content">    
      <div class="modal-header">
        ...
        <h4 class="modal-title">Agregar nueva Categoría </h4>
         <a href="{{route('categoria_egresos.index')}}" class="btn btn-success pull-right"> <span class="fa fa-list"></span>&nbsp;&nbsp;Lista Egresos Categorías</a>
      </div>
      <div class="modal-body">
      <form class="modal-content" action="{{route('categoria_egresos.store')}}" method="post">
      @csrf
        <div class="row">
          <!-- left column -->
          <div class="col-md-12">
       ...
       <!--            <div> <button class="btn btn-info pull-right">Ver todas las categorias</button>
                  ...
                  <div class="col-md-12">
                    <div class="form-group @error('categoria') has-error @enderror">
                      <label for="categoria-add">CATEGORÍA Egreso</label>
