...
<section class="content">
  ...
  @include('reporte_ganancia_grifo.neto.anual.filtrado')    
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#home">Ingresos Grifos neto Total Anual</a></li>
        <li><a href="#menu1">Ingresos neto Por Grifo anual</a></li>
      </ul>
      <div class="tab-content">
        <div id="home" class="tab-pane fade in active">
          <div class="row">
            @include('reporte_ganancia_grifo.neto.anual.table')
            @include('reporte_ganancia_grifo.neto.anual.chart')  
          </div>  
        </div>
        <div id="menu1" class="tab-pane fade">
            @include('reporte_ganancia_grifo.neto.anual.table_grifos')
            @include('reporte_ganancia_grifo.neto.anual.chart_grifos')  
        </div>
      </div>
    </div>
  </div>
...
$(document).ready(function() {
  ...
  $("#datepicker").change(function(){
    if ($(this).val()) {
      ...
      RefreshTable('#tabla-ingresos',`./reporte_ingresos_grifos_anual_data/${year}`);
      {{ $chart_grifos->id }}_refresh(original_api_url_grifos + "?year="+year);
      RefreshTable('#tabla-grifos-ingresos',`./reporte_ingresos_x_grifo_anual_data/${year}`);
    }      
  });
  ...
  $('#tabla-ingresos').DataTable({
      ...
      "ordering": false,
      "dom": 'Blfrtip',
      'ajax': `./reporte_ingresos_grifos_anual_data`,
      'columns': [
        {data: 'mes_year'},     
        {data: 'monto_egreso'}
      ],
  ...
  $('#tabla-grifos-ingresos').DataTable({
      "pageLength": 50,      
      "searching": false,
      "ordering": false,
      "dom": 'Blfrtip',
      'ajax': `./reporte_ingresos_x_grifo_anual_data`,
      'columns': [
        {data: 'grifo'},     
        {data: 'monto_neto'}
      ],
