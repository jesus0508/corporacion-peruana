<div class="modal fade" id="modal-edit-movimientos-grifos" style="display: none;">
  <div class="modal-dialog">
    <form action="{{route('movimiento_grifos.update',0)}}" method="post" class="modal-content movimiento">
      @csrf
      @method('PUT')
