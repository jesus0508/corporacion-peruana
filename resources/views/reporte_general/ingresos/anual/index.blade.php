...
<section class="content">
  ...
  @include('reporte_general.ingresos.anual.header')  
  <div class="row">
  @include('reporte_general.ingresos.anual.table')
  @include('reporte_general.ingresos.anual.chart')  
  </div>	
...
$(document).ready(function() {
  ...
  $("#datepicker").change(function(){
    if ($(this).val()) {
      ...
      RefreshTable('#tabla-ingresos',`./reporte_general_ingresos_anual_data/${year}`);
    }      
  });
  ...
  $('#tabla-ingresos').DataTable({
      ...
      "ordering": false,
      "dom": 'Blfrtip',
      'ajax': `./reporte_general_ingresos_anual_data`,
      'columns': [
        {data: 'mes_year'},     
        {data: 'monto_ingreso'}
      ],
